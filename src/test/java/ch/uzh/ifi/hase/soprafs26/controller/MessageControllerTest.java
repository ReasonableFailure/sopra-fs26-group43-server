...
public class MessageControllerTest {
    ...
    public void getMessagesBetween_validIds_messagesReturned() throws Exception {
        given(messageService.getMessagesBetween("token123", 1L, 2L))
        ...
        verify(messageService, times(1)).getMessagesBetween("token123", 1L, 2L);
    }

    @Test
    public void getMessagesBetween_charactersNotFound_throwsException() throws Exception {
        given(messageService.getMessagesBetween("token123", 999L, 2L))
        ...
        verify(messageService, times(1)).getMessagesBetween("token123", 999L, 2L);
    }
